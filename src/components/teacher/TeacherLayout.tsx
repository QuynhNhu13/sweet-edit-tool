            ...
            {!collapsed && (
              <div className="min-w-0">
                ...
                <p className="text-[11px] text-muted-foreground leading-tight flex items-center gap-1">
                  <ShieldCheck className="w-3 h-3 text-emerald-500" /> Giáo viên
                </p>
              </div>
            )}
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="pl-3 border-l border-border flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-emerald-600 leading-tight flex items-center gap-1"><ShieldCheck className="w-3 h-3" /> Verified Teacher</p>
                </div>
              </div>
            </div>
          </header>
